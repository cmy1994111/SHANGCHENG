		...
		<view class="glance-shop-cart-order">
			...
			<view >
				...
				<view class="glance-shop-cart-scrollx-items-item-sel" :class="[ isselectedall ? 'glance-shop-cart-itemselected-img':'glance-shop-cart-itemunselected-img']"
				 @click="clickitemselectedall">

				</view>
			</view>
			<!-- 总数量 -->
			<view class="glance-shop-cart-total-cnt" style="font-size:28rpx;">全选：( {{ cntitems }} )</view>
			<!-- 总金额 -->
			<view class="glance-shop-cart-total-amt">
				
				<view style="display: flex;width: 269rpx;height: 45rpx;">
					<text style="font-size: 28rpx;color:#333333;">合计：</text>
					<text style="font-size:26rpx;margin-top: 10rpx;">￥</text>
					<text>{{ totalamount }}</text>
				</view>
			</view>
			<!-- 立即下单 -->
			<view class="glance-shop-cart-create-order" @click="createorder" style="height: 98rpx;width: 200rpx;line-height: 98rpx; background:#1A78DF;color: #FFFFFF; text-align:center">选好了</view>
		</view>
	</view>
</template>
